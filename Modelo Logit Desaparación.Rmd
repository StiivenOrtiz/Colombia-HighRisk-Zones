...
```{r}
require(caret)
BaseEntrenamiento <- createDataPartition(y = Basef$y, p = 0.7, list = FALSE)
Entrenamiento <- Basef[BaseEntrenamiento, ] # Base de entrenamiento
Test <- Basef[-BaseEntrenamiento, ] # Base de prueba
